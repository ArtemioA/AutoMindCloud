...
def show_view(rotate_axis, rotate_angle, title=""):
    # Rotate the object
...
def SketchRender(Sketch):
  # Standard views using rotation
  show_view((1,0,0), 0, "Front View")
  show_view((1,0,0), 90, "Top View")
  show_view((0,1,0), 90, "Right Side View")

  # Isometric view (rotate 45° around X then 30° around Z)
  rotated = Sketch.rotate((0,0,0), (1,0,0), 45).rotate((0,0,0), (0,0,1), 30)
  svg_str = exporters.getSVG(rotated.val())
  display(SVG(svg_str))
